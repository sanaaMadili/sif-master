...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Reception}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ReceptionResource {
    ...
    public ResponseEntity<Reception> createReception(@RequestBody Reception reception) throws URISyntaxException {
        ...
        Reception result = receptionRepository.save(reception);
    ...
    public ResponseEntity<Reception> partialUpdateReception(
        ...
        Optional<Reception> result = receptionRepository
            .findById(reception.getId())
            .map(existingReception -> {
                if (reception.getPays() != null) {
                    existingReception.setPays(reception.getPays());
                }
                if (reception.getAddress() != null) {
    ...
    public ResponseEntity<List<Reception>> getAllReceptions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Receptions");
        Page<Reception> page = receptionRepository.findAll(pageable);
