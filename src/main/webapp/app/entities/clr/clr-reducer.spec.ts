...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './clr.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLR_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLR actions', async () => {
      const expectedActions = [
        {
