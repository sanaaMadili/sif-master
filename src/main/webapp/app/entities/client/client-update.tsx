...
export const ClientUpdate = () => {
  ...
  const saveEntity = values => {
    const entity = {
      ...clientEntity,
      ...values,
      extraUser: extraUsers.find(it => it.id.toString() === values.extraUser.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...clientEntity,
          extraUser: clientEntity?.extraUser?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sifApp.client.home.createOrEditLabel" data-cy="ClientCreateUpdateHeading">
            <Translate contentKey="sifApp.client.home.createOrEditLabel">Create or edit a Client</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="extraUser"
                data-cy="extraUser"
                label={translate('sifApp.client.extraUser')}
                type="select"
              >
                <option value="" key="0" />
                {extraUsers
