...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reception.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECEPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECEPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECEPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECEPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECEPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECEPTION actions', async () => {
      const expectedActions = [
        {
