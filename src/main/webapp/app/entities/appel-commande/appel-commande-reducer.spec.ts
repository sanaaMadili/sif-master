...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPELCOMMANDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_APPELCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_APPELCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_APPELCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_APPELCOMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_APPELCOMMANDE actions', async () => {
      const expectedActions = [
        {
