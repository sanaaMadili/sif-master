...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './coe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COE_LIST actions', async () => {
    ...
    it('dispatches FETCH_COE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COE actions', async () => {
      const expectedActions = [
        {
