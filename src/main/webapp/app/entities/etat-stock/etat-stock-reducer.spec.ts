...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETATSTOCK_LIST actions', async () => {
    ...
    it('dispatches FETCH_ETATSTOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ETATSTOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ETATSTOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ETATSTOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ETATSTOCK actions', async () => {
      const expectedActions = [
        {
