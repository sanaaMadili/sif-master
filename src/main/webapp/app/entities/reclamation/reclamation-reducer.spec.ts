...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECLAMATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECLAMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECLAMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECLAMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECLAMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECLAMATION actions', async () => {
      const expectedActions = [
        {
