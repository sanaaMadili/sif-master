...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXTRAUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXTRAUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXTRAUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXTRAUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXTRAUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXTRAUSER actions', async () => {
      const expectedActions = [
        {
