...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAGASINIER_LIST actions', async () => {
    ...
    it('dispatches FETCH_MAGASINIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MAGASINIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MAGASINIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MAGASINIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MAGASINIER actions', async () => {
      const expectedActions = [
        {
