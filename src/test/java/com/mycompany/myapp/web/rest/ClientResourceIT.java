...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().profession(DEFAULT_PROFESSION);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().profession(UPDATED_PROFESSION);
        return client;
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.profession(UPDATED_PROFESSION);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.profession(UPDATED_PROFESSION);
